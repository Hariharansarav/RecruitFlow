  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-2 text-sm text-zinc-500">
        ...
        <span>/</span>
        <span className="text-zinc-950 font-semibold">Create Job</span>
      </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <input
              ...
              maxLength={100}
              className={`w-full px-4 py-3 rounded-xl border text-sm focus:outline-none focus:ring-2 transition-all bg-white text-zinc-950 ${
                errors.title
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            maxLength={5000}
            className={`w-full px-4 py-3.5 rounded-xl border text-sm focus:outline-none focus:ring-2 transition-all resize-y leading-relaxed bg-white text-zinc-950 ${
              errors.description
                ? 'border-red-300 focus:border-red-500 focus:ring-red-100 bg-red-50/20'
                : 'border-zinc-300 focus:border-black focus:ring-black/10'
            }`}
